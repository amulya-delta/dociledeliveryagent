...
def test_ordercompleted_dropdown_button_click_tc_05():
    ...
    try:
        ...
        write_test_result(issue_id='5', issue_description='order complete button click', test_result='Failed',
                          ...
                          additional_notes_comments='Error encountered')
##############################################################################################################################################################
def test_orderdetails_completed_okay_tc_06():
    driver_manager = AppiumDriverManager()
    driver = driver_manager.appium_driver()
    try:
        main.TestAppiumAutomation.test_orderdetails_button_completed_okay(driver)
        time.sleep(7)
        screenshot_path = "test_completed_orderdetails.png"
        driver.save_screenshot(screenshot_path)
        screenshot = xlImage(screenshot_path)
        ...
        # print("login success")
        # Write test result to Excel
        write_test_result(issue_id='6', issue_description='order complete  button click',
                          test_result='Passed', screenshot=screenshot,
                          severity_level='None', steps_to_reproduce='None',
                          expected_behavior='order complete button click xpath"',
                          actual_behavior='As Expected',
        ...
        screenshot = xlImage(screenshot_path)
        # Write test result to Excel
        write_test_result(issue_id='6', issue_description='order complete button click', test_result='Failed',
                          screenshot=screenshot,
                          severity_level='High', steps_to_reproduce='1. Open app\n2. Enter valid credentials',
                          expected_behavior='order complete button click xpath"',
                          actual_behavior='As Expected', device_platform='Android',
...
#                           additional_notes_comments='Error encountered')
# #############################################################################################################################
# def test_performance_button_click_tc_08():
#     driver_manager = AppiumDriverManager()
#     driver = driver_manager.appium_driver()
#     try:
...
#         # print("login success")
#         # Write test result to Excel
#         write_test_result(issue_id='8', issue_description='performance button click"',
#                           test_result='Passed', screenshot=screenshot,
#                           severity_level='None', steps_to_reproduce='None',
...
#         screenshot = xlImage(screenshot_path)
#         # Write test result to Excel
#         write_test_result(issue_id='8', issue_description='performance button click"', test_result='Failed',
#                           screenshot=screenshot,
#                           severity_level='High', steps_to_reproduce='1. Open app\n2. Enter valid credentials',
#                           expected_behavior='performance button click xpath"',
#                           actual_behavior='As Expected', device_platform='Android',
...
#
# #########################################################################################################################################
# def test_account_button_click_tc_09():
#     driver_manager = AppiumDriverManager()
#     driver = driver_manager.appium_driver()
#     try:
...
#         # print("login success")
#         # Write test result to Excel
#         write_test_result(issue_id='9', issue_description='Login button click',
#                           test_result='Passed', screenshot=screenshot,
#                           severity_level='None', steps_to_reproduce='None',
...
#         screenshot = xlImage(screenshot_path)
#         # Write test result to Excel
#         write_test_result(issue_id='9', issue_description='Login button click', test_result='Failed',
#                           screenshot=screenshot,
#                           severity_level='High', steps_to_reproduce='1. Open app\n2. Enter valid credentials',
#                           expected_behavior='Login button click xpath"',
#                           actual_behavior='As Expected', device_platform='Android',
#                           additional_notes_comments='Error encountered')
# #######################################################################################################################
# def  test_dutystatus_button_click_tc_10():
#     driver_manager = AppiumDriverManager()
#     driver = driver_manager.appium_driver()
#     try:
...
#         # print("login success")
#         # Write test result to Excel
#         write_test_result(issue_id='10', issue_description='Duty status button click',
#                           test_result='Passed', screenshot=screenshot,
#                           severity_level='None', steps_to_reproduce='None',
...
#         screenshot = xlImage(screenshot_path)
#         # Write test result to Excel
#         write_test_result(issue_id='10', issue_description='Duty status button click', test_result='Failed',
#                           screenshot=screenshot,
#                           severity_level='High', steps_to_reproduce='1. Open app\n2. Enter valid credentials',
...
#                           additional_notes_comments='Error encountered')
# #########################################################################################################################################
# def test_logout_button_click_TC_11():
#     driver_manager = AppiumDriverManager()
#     driver = driver_manager.appium_driver()
#     try:
...
#         # print("login success")
#         # Write test result to Excel
#         write_test_result(issue_id='11', issue_description='Logout button click',
#                           test_result='Passed', screenshot=screenshot,
#                           severity_level='None', steps_to_reproduce='None',
...
#         screenshot = xlImage(screenshot_path)
#         # Write test result to Excel
#         write_test_result(issue_id='11', issue_description='Logout button click', test_result='Failed',
#                           screenshot=screenshot,
#                           severity_level='High', steps_to_reproduce='1. Open app\n2. Enter valid credentials',
#                           expected_behavior='Logout button   click xpath"',
#                           actual_behavior='As Expected', device_platform='Android',
